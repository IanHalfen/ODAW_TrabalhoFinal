                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    <?php
                      ...
                      $id = intval($_GET['id']);
                      //var_dump($id);
                      // Consulta SQL para buscar os dados do post com o ID correspondente
                      if($id>0){
                        ...
                        $sql = "SELECT COUNT(*) AS total_comentarios FROM comentarios WHERE id_post = $id";
                        $result_comentarios = mysqli_query($conexao, $sql);
                        $row_comentarios = mysqli_fetch_assoc($result_comentarios);
                        //var_dump($row_comentarios['total_comentarios']);
                      }
                      else {
                        // Lidar com o valor inválido de ID
                        echo "ID inválido";
                      }
                    ...
                    <div class="down-content">
                      <?php
                        ...
                        echo '<li><a href="#">' . $row_comentarios['total_comentarios'] . ' Comentários</a></li>'; 
                        echo '</ul>';
                        ...
                        <?php
                          ...
                          if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                              ...
                              echo      '<img src="assets/images/comment-author-01.jpg" alt="">';
                              echo   '</div>';
                      ...
                      <?php
                        if(isset($_SESSION['isLogged'])){
                          if($_SESSION['isLogged']){
                            echo '<form id="comment" action="comment.php?post_id=' . $_GET['id'] . '" method="post">';
                            echo   '<div class="row">';
                            echo     '<div class="col-lg-12">';
                            echo        '<fieldset>';
                            echo             '<textarea name="comentario" rows="6" id="comentario" placeholder="Escreva seu comentário" required=""></textarea>';
                            echo        '</fieldset>';
                            echo      '</div>';
                            echo      '<div class="col-lg-12">';
                            echo         '<fieldset>';
                            echo            '<button type="submit" id="form-submit" class="main-button">Submit</button>';
                            echo         '</fieldset>';
                            echo      '</div>';
                            echo   '</div>';
                            echo '</form>';
